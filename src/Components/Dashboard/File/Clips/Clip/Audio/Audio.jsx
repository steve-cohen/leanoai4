...
export default function Audio({ end, file, formatTime, start }) {
	...
	return file ? (
		<div className='Video' style={{ background: '#4f566b', borderRadius: '4px', height: '100px' }}>
			<video id='media' onClick={handleVideo} ref={mediaRef} src={fileURL} />
