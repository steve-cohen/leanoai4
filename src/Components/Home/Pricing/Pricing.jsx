...
const hobbyFeatures = ['2 hours of video or audio', '$14.50 per hour']
const growthFeatures = ['10 hours of video or audio', '$9.90 per hour', '30% savings']
const scaleFeatures = ['30 hours of video or audio', '$8.30 per hour', '40% savings']

export default function Pricing() {
	const { loginWithRedirect } = useAuth0()

	return (
		<div className='scale-90' id='pricing'>
			<div className='px-4 pt-12 sm:px-6 lg:px-8 lg:pt-20'>
				<div className='text-center'>
					...
					<h2 className='text-xl font-semibold leading-6 text-gray-900'>Pricing</h2>
					...
					<p className='mx-auto mt-3 max-w-4xl text-xl text-gray-500 sm:mt-5 sm:text-2xl'>
						Select the plan that fits your content needs. Upgrade or downgrade when you need to. Cancel at any time.
					</p>
				</div>
			</div>
											...
											<div className='mt-8'>
												<div className='rounded-lg shadow-md'>
													<span
														...
														className='cursor-pointer block w-full rounded-lg border border-transparent bg-white px-6 py-3 text-center text-base font-medium text-indigo-600 hover:bg-gray-50'
									...
									<div className='rounded-b-lg border-t-2 border-gray-100 bg-gray-50 px-6 pt-10 pb-8 sm:px-10 sm:py-10'>
										...
										<div className='mt-10'>
											<div className='rounded-lg shadow-md'>
												<span
													onClick={() => loginWithRedirect({ screen_hint: 'signup' })}
													className='cursor-pointer block w-full rounded-lg border border-transparent bg-indigo-600 px-6 py-4 text-center text-xl font-medium leading-6 text-white hover:bg-indigo-700'
